                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook_id_name" value="{{ old('facebook_id_name') }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="linkedin_id_name" value="{{ old('linkedin_id_name') }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="linkedin_url" value="{{ old('linkedin_url') }}"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="twitter_id_name" value="{{ old('twitter_id_name') }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
